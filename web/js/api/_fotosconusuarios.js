...
const fotosconusuariosAPI_auto = {

    /**
    * Gets all fotosconusuarios
    */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/fotosconusuarios`,requestOptions);
        return response.data;
    },
};

export {fotosconusuariosAPI_auto};